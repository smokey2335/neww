...
function openFirstPopup() {
    var popup = window.open('https://bit.ly/Mia__Malkova', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/Mia__Malkova', '_blank');
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/fuckthispusy', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/fuckthispusy', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
