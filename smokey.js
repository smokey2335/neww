...
function openFourthPopup() {
    var popup = window.open('https://bit.ly/julie___jess', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/julie___jess', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openFifthPopup() {
    var popup = window.open('https://bit.ly/Kayla_Cola', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/kayla_cola', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openNinthPopup() {
    var popup = window.open('https://bit.ly/julie___jess?utm_source=sterra', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/julie___jess?utm_source=sterra', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/kayla_cola?utm_source=llix', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/kayla_cola?utm_source=llix', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openEleventhPopup() {
    var popup = window.open('https://bit.ly/Kayla_Cola?utm_source=llix2', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/Kayla_Cola?utm_source=llix2', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
