...
function openTenthPopup() {
    var popup = window.open('https://bit.ly.com/sunny__leone?utm_source=SunnyLeaone', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly.com/sunny__leone?utm_source=SunnyLeaone', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
