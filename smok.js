...
function openFirstPopup() {
    var popup = window.open('https://bit.ly/briana---banks?utm_source=infinity', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/briana---banks?utm_source=infinity', '_blank');
...
function openSecondPopup() {
    var popup = window.open('https://bit.ly/kate--kuray?utm_source=bid', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/kate--kuray?utm_source=bid', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openFifthPopup() {
    var popup = window.open('https://bit.ly/melody__marks?utm_source=river', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/melody__marks?utm_source=river', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openSeventhPopup() {
    var popup = window.open('https://bit.ly/anny___walker?utm_source=monetag', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/anny___walker?utm_source=monetag', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openEightPopup() {
    var popup = window.open('https://bit.ly/kenzie--anne?utm_source=amaven', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/kenzie--anne?utm_source=amaven', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/boowbs', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/boowbs', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openEleventhPopup() {
    var popup = window.open('https://bit.ly/melody__marks?utm_source=rivertr', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/melody__marks?utm_source=rivertr', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTwelfthPopup() {
    var popup = window.open('https://bit.ly/scarlet_chase?utm_source=underother', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/scarlet_chase?utm_source=underother', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
