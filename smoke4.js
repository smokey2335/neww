...
function openFirstPopup() {
    var popup = window.open('https://bit.ly/alina_lopez', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/alina_lopez', '_blank');
...
function openFifthPopup() {
    var popup = window.open('https://bit.ly/alina_lopez?utm_source=AlinaLopez', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/alina_lopez?utm_source=AlinaLopez', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
