...
function openFifthPopup() {
    var popup = window.open('https://bit.ly/smashwatchmob?utm_source=smashezmob', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/smashwatchmob?utm_source=smashezmob', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
