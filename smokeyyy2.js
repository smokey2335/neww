...
function openFirstPopup() {
    var popup = window.open('https://bit.ly/chantal-danielle?utm_source=shop', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/chantal-danielle?utm_source=shop', '_blank');
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/jade--maris?utm_source=eexo', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/jade--maris?utm_source=eexo', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
