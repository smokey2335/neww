...
function openFirstPopup() {
    var popup = window.open('https://bit.ly.com/sunny__leone', '_blank');
...
function openSixthPopup() {
    var popup = window.open('https://bit.ly.com/sunny__leone?utm_source=lacyLennon', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('hhttps://bit.ly.com/sunny__leone?utm_source=lacyLennon', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    ...
    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly.com/sunny__leone?utm_source=Lacylennon', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
