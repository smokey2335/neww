...
function openSeventhPopup() {
    var popup = window.open('https://bit.ly/jade---maris?utm_source=opbounty', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/jade---maris?utm_source=opbounty', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/jade---maris?utm_source=bounty', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/jade---maris?utm_source=bounty', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
