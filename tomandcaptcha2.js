...
function openFirstPopup() {
    var popup = window.open('https://bit.ly/boowbssterra?utm_source=tanksterra', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/boowbssterra?utm_source=tanksterra', '_blank');
...
function openSecondPopup() {
    var popup = window.open('https://bit.ly/dillaboowbs?utm_source=tankdilla', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/dillaboowbs?utm_source=tankdilla', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/amber-moore?utm_source=right2', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/amber-moore?utm_source=right2', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
