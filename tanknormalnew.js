...
function openFirstPopup() {
    ...
    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/sunny__leone', '_blank');
...
function openFourthPopup() {
    var popup = window.open('https://bit.ly/sonya___blaze', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/sonya___blaze', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openSixthPopup() {
    var popup = window.open('https://bit.ly/jenna_Jameson?utm_source=lacyLennon', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/jenna_Jameson?utm_source=lacyLennon', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openSeventhPopup() {
    var popup = window.open('https://bit.ly/lacy___lennon', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/lacy___lennon', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/scarlette_jones?utm_source=Lacylennon', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/sunny__leone?utm_source=Lacylennon', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openEleventhPopup() {
    var popup = window.open('https://bit.ly/euphorfun', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/euphorfun', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
