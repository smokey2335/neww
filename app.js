...
function openSecondPopup() {
    var popup = window.open('https://bit.ly/mia_-melano', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/mia_-melano', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openTenthPopup() {
    var popup = window.open('https://bit.ly/marcosong', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/marcosong', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
